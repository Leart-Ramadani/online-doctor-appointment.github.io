...
<body>
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidebar">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li><a href="pacientat.php" class="nav-link text-white active" aria-current="page">Historia e termineve</a></li>
    ...
    <main>
                    ...
                    <?php foreach ($data as $data) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="text-decoration-none text-white" href="deleteHistorinTerminit.php?id=<?= $data['id']  ?>"><button class="btn btn-danger w-100 mt-1 p-1 text-white">Delete</button></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <?php if ($empty == 'empty') : ?>
            <article style="margin-left: 200px;" class="text-center">
                <h1 class=" h1 fw-normal text-center">Nuk ka te dhena ne databaaze.</h1>
            </article>
        <?php endif; ?>
    </main>
