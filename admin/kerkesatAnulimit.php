...
<body>
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidebar">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li><a href="kerkesatAnulimit.php" class="nav-link text-white active" aria-current="page">Kerkesat e anulimit te termineve</a></li>
        </ul>
        <hr>
        <div class="dropdown">
    ...
    <main>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none text-white" href="tedhenatKerkesave.php?id=<?= $data['id']  ?>">
                                    <button class="btn btn-primary w-100 p-1 text-white mb-1">Shiko detajet</button>
                                </a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
        ...
        <?php if ($empty == 'empty') : ?>
            <article style="margin-left: 200px;" class="text-center">
                <h1 class=" h1 fw-normal text-center">Nuk ka asnje kerkes te paraqitur deri me tani.</h1>
            </article>
        <?php endif; ?>
    </main>
